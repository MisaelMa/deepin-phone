...
*/
#ifndef PHONETREEMUSICMODEL_H
#define PHONETREEMUSICMODEL_H
...
class PhoneTreeMusicModel : public BaseItemModel
{
    Q_OBJECT
public:
    explicit PhoneTreeMusicModel(QObject *parent = nullptr);
