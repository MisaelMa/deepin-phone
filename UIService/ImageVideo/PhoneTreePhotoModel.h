...
*/
#ifndef PHONETREEPHOTOMODEL_H
#define PHONETREEPHOTOMODEL_H
...
class PhoneTreePhotoModel : public BaseItemModel
{
    Q_OBJECT
public:
    explicit PhoneTreePhotoModel(QObject *parent = nullptr);
